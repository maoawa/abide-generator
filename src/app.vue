...
const generate = () => {
  ...
  url.searchParams.append(
    'yourdegree',
    degreeSelect.value === 'custom' ? degreeCustom.value : degreeSelect.value
  );
  url.searchParams.append(
    'study',
    studySelect.value === 'custom' ? studyCustom.value : studySelect.value
  );
...
<template>
  <div class="container">
    ...
    <span class="text">
      ...
      is a special academic title awarded without traditional study, recognizing
      unique contributions or status.
    </span>
    ...
    <var-checkbox v-model="agree"></var-checkbox>
    <span id="agree-checkbox-text">
    ...
    <br />
    <span class="comment">
      By pressing Generate, you agree to be redirected to Abide University's
      website.
    </span>
    ...
    property of Dudeism LLC. Dudeism LLC is a limited liability company based in
    California, USA, and owner of the Abide University brand.
    <br />
    Abide Generator is an independent utility designed for quick access to
    specific pages on the official Abide University website. It is completely
    not affiliated with or endorsed by Abide University.
    <div class="placeholder"></div>
